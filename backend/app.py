...
GRADE_INFO = {
    ...
    1: {"grade": "Grade 1 (Mild)", "desc": "Mild non-proliferative diabetic retinopathy classification.", "lesions": "Microaneurysm-like features may have contributed to the classification.", "rec": "Regular ophthalmic follow-up recommended.", "ref": "Routine ophthalmology follow-up."},
...
def screening_interpretation(pred_class: int, confidence: float) -> str:
    if pred_class == 0 and confidence < 0.70:
        return "No DR was classified, but confidence is limited; professional review is recommended."
